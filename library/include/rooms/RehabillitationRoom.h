...
public:
     ...
     * @param room_number Numer przypisany do sali rehabilitacyjnej.
     * @param accessible_equpiment Wektor przechowujący listę wyposażenia dostępnego w sali.
     * @param max_capacity Maksymalna pojemność sali - liczba personelu.
     */
