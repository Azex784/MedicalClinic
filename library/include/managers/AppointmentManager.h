...
namespace MedicalClinic
{
	...
	public:
		 ...
		 */
		AppointmentManager(const std::string& fileName, const std::string& fileNameArchive,
		...
		*/
		 ...
		 */
		bool isDate(std::vector<AppointmentPtr> appointments, const boost::posix_time::ptime beginDate,
